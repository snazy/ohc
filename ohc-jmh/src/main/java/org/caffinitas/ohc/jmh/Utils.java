...
public final class Utils
{
    ...
    {
        public void serialize(byte[] bytes, ByteBuffer buf) throws IOException
        {
            buf.putInt(bytes.length);
            buf.put(bytes);
        }

        public byte[] deserialize(ByteBuffer buf) throws IOException
        {
    ...
    {
        public void serialize(Integer integer, ByteBuffer buf) throws IOException
        {
            buf.putInt(integer);
        }

        public Integer deserialize(ByteBuffer buf) throws IOException
        {
            return buf.getInt();
        }
